...
Core framework package with all internal modules (types, utils, stores, schemas, hooks, i18n)
...
- [Report a bug](https://github.com/donotdev/core/issues/new?template=bug_report.md)
- [Request a feature](https://github.com/donotdev/core/issues/new?template=feature_request.md)
