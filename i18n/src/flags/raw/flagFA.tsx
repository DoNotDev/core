// packages/core/i18n/src/flags/raw/flagFA.tsx

/**
 * @fileoverview Persian/Farsi Flag Component
 * @description React component for displaying the Persian/Farsi flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagFA.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function FASvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(FASvg);
