// packages/core/i18n/src/flags/raw/flagES.tsx

/**
 * @fileoverview Spanish Flag Component
 * @description React component for displaying the Spanish flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagES.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function ESSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(ESSvg);
