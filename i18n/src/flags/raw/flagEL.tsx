// packages/core/i18n/src/flags/raw/flagEL.tsx

/**
 * @fileoverview Greek Flag Component
 * @description React component for displaying the Greek flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagEL.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function ELSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(ELSvg);
