// packages/core/i18n/src/flags/raw/flagMT.tsx

/**
 * @fileoverview Maltese Flag Component
 * @description React component for displaying the Maltese flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagMT.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function MTSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
      ...
      className={className}
      style={style}
      aria-label={title || 'MT flag'}
      role="img"
    >
      <path fill="#fff" strokeWidth=".00818411" d="M0 0h640v480H0Z" />
      <path fill="#cf142b" strokeWidth=".00818411" d="M320 0h320v480H320Z" />
      <g
        fill="#fff"
        stroke="#000"
        strokeWidth="96"
      ...
      <g
        ...
        strokeWidth="36"
      >
        <path strokeWidth=".7" d="M137.9 185.8a588.3 588.3 0 0 1 48 0" />
        <path
          strokeWidth=".4"
...
export default createFlagComponent(MTSvg);
