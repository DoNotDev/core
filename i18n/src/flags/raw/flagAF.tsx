// packages/core/i18n/src/flags/raw/flagAF.tsx

/**
 * @fileoverview Afghanistan Flag Component
 * @description React component for displaying the Afghanistan flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagAF.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function AFSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(AFSvg);
