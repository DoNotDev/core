// packages/core/i18n/src/flags/raw/flagKG.tsx

/**
 * @fileoverview Kyrgyz Flag Component
 * @description React component for displaying the Kyrgyz flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagKY.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function KYSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(KYSvg);
