// packages/core/i18n/src/flags/raw/flagMD.tsx

/**
 * @fileoverview Moldovan Flag Component
 * @description React component for displaying the Moldovan flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagMD.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function MDSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(MDSvg);
