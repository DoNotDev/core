// packages/core/i18n/src/flags/raw/flagSI.tsx

/**
 * @fileoverview Slovenian Flag Component
 * @description React component for displaying the Slovenian flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagSI.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function SISvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(SISvg);
