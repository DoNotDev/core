// packages/core/i18n/src/flags/raw/flagPS.tsx

/**
 * @fileoverview Palestinian Flag Component
 * @description React component for displaying the Palestinian flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagPS.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function PSSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(PSSvg);
