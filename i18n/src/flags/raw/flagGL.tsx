// packages/core/i18n/src/flags/raw/flagGL.tsx

/**
 * @fileoverview Greenlandic Flag Component
 * @description React component for displaying the Greenlandic flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagGL.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function GLSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(GLSvg);
