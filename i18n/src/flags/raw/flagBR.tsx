// packages/core/i18n/src/flags/raw/flagBR.tsx

/**
 * @fileoverview Brazilian Flag Component
 * @description React component for displaying the Brazilian flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
function BRSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(BRSvg);
