// packages/core/i18n/src/flags/raw/flagTJ.tsx

/**
 * @fileoverview Tajik Flag Component
 * @description React component for displaying the Tajik flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagTG.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function TGSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(TGSvg);
