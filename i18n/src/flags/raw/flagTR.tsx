// packages/core/i18n/src/flags/raw/flagTR.tsx

/**
 * @fileoverview Turkish Flag Component
 * @description React component for displaying the Turkish flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagTR.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function TRSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(TRSvg);
