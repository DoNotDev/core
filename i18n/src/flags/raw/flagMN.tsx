// packages/core/i18n/src/flags/raw/flagMN.tsx

/**
 * @fileoverview Mongolian Flag Component
 * @description React component for displaying the Mongolian flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagMN.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function MNSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(MNSvg);
