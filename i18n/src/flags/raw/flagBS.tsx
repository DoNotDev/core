// packages/core/i18n/src/flags/raw/flagBS.tsx

/**
 * @fileoverview Bahamian Flag Component
 * @description React component for displaying the Bahamian flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagBS.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function BSSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(BSSvg);
