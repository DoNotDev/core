// packages/core/i18n/src/flags/raw/flagMS.tsx

/**
 * @fileoverview Malay Flag Component
 * @description React component for displaying the Malay flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagMS.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function MSSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(MSSvg);
