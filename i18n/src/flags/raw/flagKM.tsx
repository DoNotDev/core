// packages/core/i18n/src/flags/raw/flagKM.tsx

/**
 * @fileoverview Comorian Flag Component
 * @description React component for displaying the Comorian flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagKM.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function KMSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(KMSvg);
