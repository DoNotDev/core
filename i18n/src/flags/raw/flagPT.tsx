// packages/core/i18n/src/flags/raw/flagPT.tsx

/**
 * @fileoverview Portuguese Flag Component
 * @description React component for displaying the Portuguese flag with customizable size and styling options.
 *
 * @version 0.1.0
 * @since 0.0.1
...
// packages/assets/flags/raw/flagPT.tsx

import { createFlagComponent, type FlagSvgProps } from './FlagBase';

function PTSvg({ width, height, className = '', style, title }: FlagSvgProps) {
  return (
    <svg
...
export default createFlagComponent(PTSvg);
